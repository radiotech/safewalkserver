...
function send(data) {
    ...
    console.log("http://safewalkserver-ahharvey.cloudapps.unc.edu/data?" + Object.keys(data).reduce(function (a, i) { return (a + (i + "=" + data[i] + "&")); }, "") + "a=1");
    req.open("GET", "http://safewalkserver-ahharvey.cloudapps.unc.edu/data?" + Object.keys(data).reduce(function (a, i) { return (a + (i + "=" + data[i] + "&")); }, "") + "a=1");
    req.send();
}
function poll() {
